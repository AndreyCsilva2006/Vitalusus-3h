...
public class VideoCanalDetailAdapter extends RecyclerView.Adapter<VideoCanalDetailAdapter.VideoCanalDetailViewHolder> {
    ...
    public VideoCanalDetailAdapter(List<Usuario> usuarioList, List<Canal> canalList, List<Treinador> treinadorList, List<Video> videoList, OnItemClickListener listener) {
...
//        this.equipamentoList = equipamentoList;
    ...
    @Override
    public void onBindViewHolder(@NonNull VideoCanalDetailViewHolder holder, int position) {
...
//        Log.d("equipamento", "ID: " + equipamento.getId());
    ...
    public static class VideoCanalDetailViewHolder extends RecyclerView.ViewHolder {
